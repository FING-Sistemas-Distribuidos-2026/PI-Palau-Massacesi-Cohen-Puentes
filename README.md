...
- PostgreSQL + PV: persistencia y estado de jobs, guesses, y frases distorsionadas.
...
6. Los guesses parciales se guardan en PostgreSQL y se emiten por SSE en tiempo real.
